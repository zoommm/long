...
static unsigned char sg_BHeader[] = {
    ...
    0x00, 0x00, 0x40, 0x01, 0x00, 0x00, 0xF0, 0x00,  0x00, 0x00, 0x01, 0x00, 0x20, 0x00,/*compress*/ 0x03, 0x00,
    0x00, 0x00, /*compress*/ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /*调色板*/  0x00, 0x00, 0xFF, 0x00, 0x00, 0xFF, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
void SaveBMPFile(unsigned char *raw, char *filename)
{
    ...
    sg_BHeader[0x02] = (UCHAR)(m_Width * m_Height * 4 + 0x36) & 0xff;
    sg_BHeader[0x03] = (UCHAR)((m_Width * m_Height * 4 + 0x36) >> 8) & 0xff;
    sg_BHeader[0x04] = (UCHAR)((m_Width * m_Height * 4 + 0x36) >> 16) & 0xff;
    sg_BHeader[0x05] = (UCHAR)((m_Width * m_Height * 4 + 0x36) >> 24) & 0xff;
    ...
    {
        unsigned int *c = p + (m_Height - 1 - i) * m_Width;
        unsigned int cc;
        for(j = 0; j < m_Width; j++)
        {
//            cc = RGB565TO1555(*(c + j));
