...
if test -f ${DESTDIR}/var/httpd//bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/var/httpd//bin/apr-1-config
   APU_CONFIG=${DESTDIR}/var/httpd//bin/apu-1-config
else
...
installbuilddir="/var/httpd//build"
