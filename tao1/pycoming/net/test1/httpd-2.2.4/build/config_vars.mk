...
shared_build =
AP_LIBS = /home/xwp/tao1/pycoming/net/test1/httpd-2.2.4/srclib/pcre/libpcre.la /home/xwp/tao1/pycoming/net/test1/httpd-2.2.4/srclib/apr-util/libaprutil-1.la -lsqlite3 -lsqlite -lexpat /home/xwp/tao1/pycoming/net/test1/httpd-2.2.4/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /home/xwp/tao1/pycoming/net/test1/httpd-2.2.4
...
EXTRA_LDFLAGS =
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/home/xwp/tao1/pycoming/net/test1/httpd-2.2.4/srclib/apr/include -I/home/xwp/tao1/pycoming/net/test1/httpd-2.2.4/srclib/apr-util/include -I$(top_srcdir)/modules/proxy/../generators -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /home/xwp/tao1/pycoming/net/test1/httpd-2.2.4/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
...
APR_INCLUDEDIR = /home/xwp/tao1/pycoming/net/test1/httpd-2.2.4/srclib/apr/include
APR_VERSION = 1.2.8
APR_CONFIG = /var/httpd//bin/apr-1-config
APU_BINDIR = /var/httpd//bin
APU_INCLUDEDIR = /home/xwp/tao1/pycoming/net/test1/httpd-2.2.4/srclib/apr-util/include
APU_VERSION = 1.2.8
